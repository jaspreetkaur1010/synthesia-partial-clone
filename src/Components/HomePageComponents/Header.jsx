...
export default function Header() {
  ...
  return () => {
    ...
    <div className="fixed w-full">
      ...
      <div
      className={` w-full bg-gradient-to-r from-indigo-950 via-blue-900 to-blue-800 text-white h-12 flex items-center justify-center px-2 md:px-6 ${isTicked ? "hidden" : ""}`}
      style={{
      ...
      <div className="flex bg-white py-4 px-4 sm:px-10 justify-between items-center"
      style={{
      transform: isHidden && !isTicked ? 'translateY(-75%)' : 'translateY(0)',
      transition: 'transform 0.5s ease-in-out',
      }}>
        <img  className="h-7" src="https://cdn.prod.website-files.com/65e89895c5a4b8d764c0d710/65eae689ace95f5017dc17a0_Logo-main.svg" alt="prodigalAI"/>
        <div className="flex items-center space-x-8">
        <button className="bg-indigo-500 hidden  sm:flex transition ease-in-out duration-200 hover:bg-indigo-900 text-white text-sm font-semibold px-4 py-2 rounded-md">Get Started</button>
